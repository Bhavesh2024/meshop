...
const validateField = (field, value) => {
  ...
  const fetchUser = async(username) =>{
      try{
        const response = await axios.get(`https://meshop-hx32.onrender.com/api/users/${username}`);
  ...
  const updateUser = async(username,userData) =>{
    try{
      const response = await axios.put(`https://meshop-hx32.onrender.com/api/users/${username}`,userData);
